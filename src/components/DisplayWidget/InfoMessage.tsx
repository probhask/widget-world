...
const InfoMessage = React.memo(() => {
  return (
    <div className="w-full h-full flex flex-col items-center mt-20 gap-y-2 text-neutral-600">
      ...
      <h6 className="flex items-center justify-center flex-wrap gap-y-0.5 gap-x-2 text-lg text-center   ">
        <span className="flex gap-0.5 flex-wrap items-center justify-center">
          Click <AiOutlinePlusCircle className="text-green-700 text-2xl" /> icon
        </span>
